...
Usaremos la version `6.12.41` del kernel (En este curso usaremos el siguiente: https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.12.41.tar.xz).  Copie el enlace del hipervínculo `tarball`. Luego use este enlace para descargar y descomprimir la fuente del kernel.

```bash
wget https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.12.41.tar.xz
